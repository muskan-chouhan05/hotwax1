...
$ Git config user.name “muskan-chouhan05”
$ Git config user.email “muskanchouhan2105@gmail.com”
...
5. $ git add -> git add is used to move your changed files into the staging area, so they are ready to be committed. 
...
Reset or revert your commit 
    Reset -> git reset is used to move your HEAD and branch pointer backward to commit.It do unstaged the file/changes , undo the commits , discard commit.
...
Git branches –
                 ...
                 	$git merge branch_name -> it use to combine the changes from one branch to another branch .
